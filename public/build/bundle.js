...
var app = (function () {
    ...
    /* src/Aside2.svelte generated by Svelte v3.59.2 */
    const file$2 = "src/Aside2.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-1apyj52");
    			add_location(img0, file$2, 6, 24, 151);
    			attr_dev(div0, "class", "aside__ad svelte-1apyj52");
    			add_location(div0, file$2, 6, 1, 128);
    			attr_dev(div1, "class", "aside__search svelte-1apyj52");
    			...
    			attr_dev(img1, "class", "svelte-1apyj52");
    			add_location(img1, file$2, 10, 24, 305);
    			attr_dev(div2, "class", "aside__ad svelte-1apyj52");
    			add_location(div2, file$2, 10, 1, 282);
    			attr_dev(div3, "class", "aside__newsletter svelte-1apyj52");
    			...
    			attr_dev(img2, "class", "svelte-1apyj52");
    			add_location(img2, file$2, 14, 24, 467);
    			attr_dev(div4, "class", "aside__ad svelte-1apyj52");
    			...
    			attr_dev(img3, "class", "svelte-1apyj52");
    			add_location(img3, file$2, 15, 24, 571);
    			attr_dev(div5, "class", "aside__ad svelte-1apyj52");
    			add_location(div5, file$2, 15, 1, 548);
    			attr_dev(div6, "class", "aside svelte-1apyj52");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Aside2', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Aside2> was created with unknown prop '${key}'`);
    	});
    ...
    class Aside2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			aside = element("aside");
    			create_component(aside2.$$.fragment);
    			t9 = space();
    			footer1 = element("footer");
    			create_component(footer0.$$.fragment);
    			add_location(header1, file, 11, 0, 264);
    			add_location(h1, file, 17, 3, 390);
    			add_location(p, file, 18, 3, 416);
    			attr_dev(div0, "class", "content content__intro svelte-jrgnes");
    			add_location(div0, file, 16, 2, 350);
    			attr_dev(div1, "class", "content__newsletter svelte-jrgnes");
    			add_location(div1, file, 20, 2, 1026);
    			attr_dev(div2, "class", "content__teasers svelte-jrgnes");
    			add_location(div2, file, 23, 2, 1089);
    			attr_dev(section, "class", "main__content svelte-jrgnes");
    			add_location(section, file, 15, 1, 316);
    			attr_dev(aside, "class", "main__aside svelte-jrgnes");
    			add_location(aside, file, 27, 1, 1157);
    			attr_dev(main, "class", "main svelte-jrgnes");
    			add_location(main, file, 14, 0, 295);
    			add_location(footer1, file, 31, 0, 1216);
    			attr_dev(div3, "class", "app svelte-jrgnes");
    			add_location(div3, file, 10, 0, 246);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(aside2, aside, null);
    			append_dev(div3, t9);
    		...
    		i: function intro(local) {
    			...
    			transition_in(aside2.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(aside2.$$.fragment, local);
